...
if (process.env.DEPLOY === 'export') {
  ...
  Try it out in your browser: http://localhost:${port}/socrata/data.sfgov.org/tmnf-yvry/FeatureServer/0/query
  Or on the command line: curl --silent http://localhost:${port}/socrata/data.sfgov.org/tmnf-yvry/FeatureServer/0/query?returnCountOnly=true
